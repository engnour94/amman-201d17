...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let statement = `The numbers ${testArray[0]},${testArray[1]},${testArray[2]} have a product of ${result}.`;
    return[result,statement];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (let i=0;i<arrayLength; i++){
       result = multiply (result,testDynamicArray[i])[0];
    };
    let statement = `The numbers ${testDynamicArray} have a product of ${result}.`;
    return[result,statement];
}
